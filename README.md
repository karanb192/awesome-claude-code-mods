...
| [cc-arcade](https://github.com/sezaakgun/cc-arcade/blob/main/.claude-plugin/plugin.json)                                                                  | Games above the Claude Code prompt (snake, Tetris, 2048, Minesweeper, Flappy, Pong, typing test, Space Invade…   | ![reach](badges/sezaakgun--cc-arcade--cc-arcade-reach.svg)                                     | every tool call                                                                                               | 2.1.272      | 15    |
